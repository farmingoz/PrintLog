...
namespace PrintLog.Hangfire.Jobs {
    public class Shiki {
        ...
        public void ReadLog(int printerId) {
            ...
            //                List<PrinterLog> newMachineLogs = new List<PrinterLog>();
            //                List<PrinterLogDetail> newMachineLogDetails = new List<PrinterLogDetail>();
            ...
            //                        if (status == "Normal") {
            //                            PrinterLog machineLog = dbContext.PrinterLogs.SingleOrDefault(s => s.PrinterId == printerId && s.JobId == jobId);
            //                            if (machineLog == null) {
            //                                PrinterLog newMachineLog = new PrinterLog() { 
            //                                    PrinterId = printerId,
            //                                    JobId = jobId,
            ...
            //                            PrinterLogDetail machineLogDetail = dbContext.PrinterLogDetails.SingleOrDefault(s => s.PrinterId == printerId && s.JobId == jobId && s.FileId == 1);
            //                            if (machineLogDetail == null) {
            //                                PrinterLogDetail newDetail = new PrinterLogDetail() {
            //                                    PrinterId = printerId,
            //                                    JobId = jobId,
            //                                    FileId = 1,
            //                                    ImportId = newImport.ImportId,
            ...
            //                    dbContext.PrinterLogs.AddRange(newMachineLogs);
            //                }
            //                dbContext.SaveChanges();
            //            }
            //        }
